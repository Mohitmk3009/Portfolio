...
//         { name: 'My SQL', logo: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original-wordmark.svg' },
//     ],
//     'Tools and Others': [
//         { name: 'Git', logo: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg' },
//         { name: 'Github', logo: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/xd/xd-original.svg' },
...
//         { name: 'Auto CAD', logo: 'https://icon-library.com/images/autodesk-autocad.png' },
//         { name: 'Star UML', logo: 'https://avatars.githubusercontent.com/u/7642181?s=200&v=4' },
...
//                                     key={skill.name}
//                                     className="bg-white lg:p-8 p-5 rounded-xl shadow-lg w-fit transform transition duration-300 justify-center flex flex-col items-center overflow-hidden hover:scale-105 relative"
//                                 >
...
//                                     />
//                                     <span className="absolute inset-0 flex items-center justify-center text-black bg-black bg-opacity-50 rounded-lg transition-opacity duration-300 opacity-0 hover:opacity-100">
//                                         {skill.name}
//                                     </span>
...
const skillsData = {
  ...
  "Tools and Others": [
    ...
    {
      name: "Auto CAD",
      logo: "https://icon-library.com/images/autodesk-autocad.png",
    },
    {
      name: "Star UML",
      logo: "https://avatars.githubusercontent.com/u/7642181?s=200&v=4",
    },
  ],
};
